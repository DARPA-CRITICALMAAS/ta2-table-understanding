...
from tum.gpp.algo_base import CandidateGraph, ScoreSource, SemType, STypeAlgorithm
from tum.gpp.graph_space import GraphSpace, SimpleEdge
from tum.gpp.postprocessing.cgraph import CGEdge, CGEdgeTriple, CGNode, CGraph
from tum.gpp.steiner_tree_v100 import SteinerTreeV100
from tum.gpp.steiner_tree_v101 import SteinerTreeV101
...
class AlgoV300(STypeAlgorithm[tuple[SemType, SemType], V200CGProbs]):
    ...
    def get_semantic_model(
        ...
        return self.to_semantic_model(ex.table.table, pred_cg, cta, kgdb)
    ...
    def to_semantic_model(
        ...
        kgdb = KGDB.get_instance(kgdb)
        sm_helper = kgdb.sm_helper

        nodes = {
            u.id: u.to_sm_node(
                table, kgdb.kgns, id2literal=lambda x: x.split(":", 1)[1]
            )
