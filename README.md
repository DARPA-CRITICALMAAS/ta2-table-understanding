...
You need to setup the environment variables by copying the `.env.template` file to `.env` and updating the variables as needed. Remember to load them into your shell environment.
